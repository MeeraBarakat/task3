...
function Ingredient(props) {
    ...
    if(props.Ingredient)
        return ( 
            <div className="Ingredient" style={{border: isDragging ? '2px solid gainsboro':'0'}}>
                <img ref={drag} className="ContolPanelImage" src={props.Ingredient.path} alt={props.Ingredient.name} style={{opacity: isDragging ? '0.5':'1'}}></img>
